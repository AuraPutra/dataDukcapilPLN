            ...
            <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 py-4 sm:py-8 px-2 sm:px-4">
                <div className="max-w-3xl mx-auto">
                    <div className="bg-white rounded-lg sm:rounded-2xl shadow-lg sm:shadow-xl p-4 sm:p-8">
                        <div className="mb-6">
                            <h1 className="text-2xl sm:text-3xl font-bold text-gray-800">Tambah User Baru</h1>
                            <p className="text-sm text-gray-600 mt-2">Lengkapi form untuk menambahkan user baru</p>
                        </div>
